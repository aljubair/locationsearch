    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left">
				...
				<ul class="nav nav-pills" style="margin-top:25px;margin-left:20px;">
												<li role="presentation" ><a href="hospital.php">Hospital</a></li>
												<li role="presentation"class="active"><a href="restaurant.php">Restaurant</a></li>
						 ...
						 <table class="table">
						  <thead >
							<tr>
								...
								<th>Rating</th>
								  ...
								  <?php
										...
										$query = "SELECT id,name,area,road_no,post_code,district FROM main_area WHERE id like '18%'";
							...
							<tr id="sort">
								...
								<td><?php echo $row["area"]." ".$row["road_no"].", ".$row["district"]." ".$row["post_code"]; ?></td>
							
								<td><?php echo $hdata; ?></br></br></br><input type="button" name="view" value="Details" id="<?php echo $row["id"]; ?>" class="btn btn-info btn-xs view_data" /></td>  
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			<h3 class="modal-title" id="myModalLabel">Xenial Restaurant</h3>
			   <h5 style="color:blue;">4.5 *(12 Location reviews)</h5>	
			  ...
			  <div class="modal-body">
					...
					<div class="row" id="restaurant_details">
