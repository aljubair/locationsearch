    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left">
				...
				<ul class="nav nav-pills" style="margin-top:25px;margin-left:20px;">
												...
												<li role="presentation" class="active"><a href="tourist.php">Tourist Place</a></li>
				</ul>
							...
							<tr>
								...
								<th>Rating</th>
								  ...
								  <?php
										...
										$query = "SELECT id,name,area,road_no,post_code,district FROM main_area WHERE id like '20%'";
						...
						<div class="modal-content">
						  <div class="modal-header">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h3 class="modal-title" id="myModalLabel">Nazrul Institute</h3>
								<h5 style="color:blue;">4.0 *(12 Location reviews)</h5>	
								<div class="btn-group" style="margin-left:690px;margin-top:px;">
								  ...
								  <div class="modal-body">
										...
										<div class="row" id="tourist_details">
...
<script>  
 $(document).ready(function(){  
      $('.view_data').click(function(){  
           var tourist_id = $(this).attr("id");  
           $.ajax({  
                url:"tdetails.php",  
                method:"post",  
                data:{tourist_id:tourist_id},  
                success:function(data){  
                     $('#tourist_details').html(data);  
                     $('#myModal').modal("show");  
                }  
           });  
      });  
