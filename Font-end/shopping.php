    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left">
				...
				<ul class="nav nav-pills" style="margin-top:25px;margin-left:20px;">
												...
												<li role="presentation" class="active"><a href="shopping.php">Shopping Mall</a></li>
							...
							<tr>
								...
								<th>Rating</th>
								  ...
								  <?php
										...
										$query = "SELECT id,name,area,road_no,post_code,district FROM main_area WHERE id like '19%'";
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			...
			<h3 class="modal-title" id="myModalLabel">Agora</h3>
			   <h5 style="color:blue;">4.3 *(12 Location reviews)</h5>	
			  ...
			  <div class="modal-body">
					...
					<div class="row" id="shopping_details">
