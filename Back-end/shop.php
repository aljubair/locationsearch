...
<head>
	<title>Admin panel-shopping</title>
		...
		<div class="row">
			<div class="col-md-2">
				  <ul class="nav nav-pills nav-stacked" style="margin-top:-10Px;">
					...
					<li class="active"><a href="shop.php">Shopping Mall</a></li>
			...
			<form action="insert_shop_query.php" method="post" enctype="multipart/form-data">
			
						<div class="form-group">
						                
								<center><h2>Shopping Mall</h2></center>
							
								</br>
								
								<label class="col-sm-1" for="ccell"><b>Shopping ID</b> </label>
							
								<div class="col-sm-4">
									<input type="text" class="form-control" id="croadnumber" name="sid" placeholder="Enter Shopping ID" ></br></input>
								</div>
								
								<label class="col-sm-1" for="ccell"><b>Category</b> </label>
							
								<div class="col-sm-4">
									<input type="text" class="form-control" id="croadnumber" name="scategory" placeholder="Enter category" ></br></input>
								</div>
								
								
								<label class="col-sm-1" for="ccell"><b>Floor</b> </label>
							
								<div class="col-sm-4">
									<input type="text" class="form-control" id="croadnumber" name="floor" placeholder="Enter floor number" ></br></input>
								</div>
